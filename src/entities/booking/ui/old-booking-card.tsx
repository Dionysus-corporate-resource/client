        ...
        <div className="space-y-4">
          ...
          <div className="">
            ...
            <p className="text-sm text-muted-foreground">
              Точный адрес узнавайте у заказчика
            </p>
            <div className="border-l h-12 bg-muted-foreground  border-dashed absolute top-14 left-8" />
          </div>
      ...
      <CardFooter className="flex items-center justify-between pt-4">
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            {/* <p className="text-sm text-muted-foreground">₽/тонна</p> */}
          </div>
        </div>
        {bookingDetailSlot}
      </CardFooter>
