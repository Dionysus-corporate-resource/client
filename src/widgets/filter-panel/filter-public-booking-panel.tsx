...
export default function FilterPublicBookingPanel({
  ...
  return (
    <div className="bg-background py-4 px-6 rounded-[30px] grid grid-cols-4 items-end gap-4">
      <div className="flex flex-col gap-2">
        ...
        <Input
          placeholder="Пшеница"
          className="border bg-background py-6 px-5 rounded-[30px] text-sm font-normal"
